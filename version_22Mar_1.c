	...
	while (sorted_stack != NULL)
	{
		...
		else if (stack_b == NULL || stack_b->data == stack_b->prev->data)
		{
			...
			apply_instructions(&stack_a, &stack_b, inst);
				 ...
				 stack_b->data > stack_b->prev->data
				 && stack_a->data < stack_b->prev->data //exclusion, new case
...
//		else if (stack_b->prev->data == stack_b->next->data && // new inclusion
...
//				 stack_b->data > stack_b->prev->data &&
//				 stack_b->data < stack_b->next->data
//				 && stack_b->prev->data != stack_b->next->data) //EXCLUSION
//		{
//			inst = RRB;
//			apply_instructions(&stack_a, &stack_b, inst);
//		}
