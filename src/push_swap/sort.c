...
//						display_step(stack_a->nodes, stack_b->nodes	, stack_b->nodes, 0, PB);
...
//		display_step(stack_a->nodes, stack_b->nodes	, stack_a->nodes, 0, PB);
	}
//	dprintf(0,"hola soy jajaj\n");
	if (stack_b->nodes != NULL && stack_a->size >1)
	{
//		printf("hola soy aldo\n");
